...
| Service | Purpose | Data processed | Location |
|---------|---------|---------------|----------|
| [Google AI (Gemini, Vertex AI)](https://cloud.google.com/terms/cloud-privacy-notice) | Live voice/video mode, text embeddings, semantic memory | Text, audio, video streams | US |
...
| [Google Cloud Vision](https://cloud.google.com/terms/cloud-privacy-notice) | Image analysis | Uploaded images | US |
| [OpenAI](https://openai.com/policies/privacy-policy) | OCR / image text extraction, text generation | Text, images | US |
| [Anthropic](https://www.anthropic.com/privacy) | AI chat (Bird), agent tasks | Text, chat messages | US |
| [Mistral AI](https://mistral.ai/terms/#privacy-policy) | Alternative AI text generation | Text | EU (France) |

## Analytics & observability

| Service | Purpose | Data processed | Location |
|---------|---------|---------------|----------|
| [PostHog](https://posthog.com/privacy) | Product analytics, feature flags (requires [cookie consent](/security/cookies)) | Usage events, feature flag evaluations — no research content | US/EU |
...
| Service | Purpose | Data processed | Location |
|---------|---------|---------------|----------|
| [TipTap](https://tiptap.dev/privacy-policy) | Rich text editing, DOCX export/import | Document content during conversion | EU |
