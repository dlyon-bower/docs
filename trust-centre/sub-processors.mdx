...
| Service | Purpose | Data processed | Location |
|---------|---------|---------------|----------|
| [Stripe](https://stripe.com/privacy) | Subscription billing, payment processing, customer portal | Payment methods, transaction data, billing email | US |

Bower uses Stripe for all payment processing. Card data is handled entirely by Stripe (PCI SAQ-A) and never touches Bower servers. Revolut Pay is available as an additional payment method.
