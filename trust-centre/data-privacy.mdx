...
Audit logs are accessible from [Settings > Security > Audit logs](https://app.bowerlabs.ai/audit) and can be exported to CSV. See the [audit logs guide](/trust-centre/audit-logs) for details.
...
For a full list of services that process your data, see our [sub-processor list](/trust-centre/sub-processors).
...
- **Cookie preferences** — control which cookies Bower uses. See our [cookie policy](/trust-centre/cookies).
...
When you delete notes, attachments, or collections, they are **moved to the archive** for 30 days. During this period you can restore them from **Settings > Security > Archive**. After 30 days, archived items are automatically and permanently deleted from the database and file storage.

- **Deleted notes and attachments** are moved to the archive. They are excluded from search, share links, and all normal views while archived.
- **Deleting a collection** archives all notes and sub-collections within it.
...
- [Cookie policy](/trust-centre/cookies) — what cookies we use and how to manage them
- [Audit logs](/trust-centre/audit-logs) — track every change in your workspace
- [Privacy Policy](/trust-centre/privacy-policy) — full legal privacy policy
- [Terms of Service](/trust-centre/terms-of-service) — terms governing your use of Bower

## Your responsibilities

- Do not store credentials, passwords, or access tokens in notes.
- Use workspace roles to control who can access your data.
- Review the [audit logs](/trust-centre/audit-logs) periodically if your workspace handles sensitive research data.
