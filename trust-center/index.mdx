...
<CardGroup cols={3}>
  ...
  <Card>
    <div style={{ textAlign: "center" }}>
      ...
      <p style={{ fontSize: "13px", color: "#d97706", fontWeight: 500, margin: 0 }}>Final stages</p>
    </div>
  </Card>
  <Card>
    <div style={{ textAlign: "center" }}>
...
Bower is under independent audit with [Advantage Partners](https://advantage-partners.com) for SOC 2 Type I, SOC 2 Type II, and the HIPAA Security Rule. No report has been issued yet, so Bower is not yet SOC 2 attested; we will publish each one here as it lands, available under NDA. If you need control documentation, a DPA, or a BAA in the meantime, email [privacy@bowerlabs.ai](mailto:privacy@bowerlabs.ai).
...
<AccordionGroup>
  ...
  <Accordion title="AI processing" icon="microchip-ai">
    Your content is sent to these providers to produce a result. **We do not use your identifiable content to train AI models, and our providers are contractually barred from training on it.** See [AI & your data](/trust-center/ai-data-handling).
...
<CardGroup cols={2}>
  ...
  <Card title="Privacy Policy" icon="scale-balanced" href="https://bowerlabs.ai/privacy">
    How we collect, use, store, and protect your personal information. Published on bowerlabs.ai.
  </Card>
  <Card title="Terms of Service" icon="file-contract" href="https://bowerlabs.ai/terms">
