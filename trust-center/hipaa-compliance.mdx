...
- Voice transcription, on Gemini (Vertex AI) with Google Cloud Speech-to-Text as the automatic fallback. Both are covered by the Google Cloud BAA, so your audio stays on Google.
