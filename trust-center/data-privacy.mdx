...
The [Terms of Service](https://bowerlabs.ai/terms) reserve a narrow right over data we have de-identified, which does not reach your results, findings, or inventions. The tests it has to pass, and what it covers today, are set out on [AI & your data](/trust-center/ai-data-handling#what-about-de-identified-data).
...
- [Terms of Service](https://bowerlabs.ai/terms): the canonical terms
