...
When Bower processes your data (voice transcription, photo text extraction, or Bird conversations), the content is sent to AI model providers for inference. **Your data is not used to train AI models.**

For exactly which providers we use, where your data goes in transit, how long it's kept, and how to lock it down, see [AI & your data](/trust-center/ai-data-handling). For the full list of every service that processes your data, see our [sub-processor list](/trust-center/sub-processors).
...
- [Privacy Policy](/trust-center/privacy-policy): full legal privacy policy
- [Terms of Service](/trust-center/terms-of-service): terms governing your use of Bower
