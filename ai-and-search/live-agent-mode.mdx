...
When you need to pause — to have a private conversation, take a phone call, or step away — put Bird in standby. In standby, Bird stops listening and does not send any data.

- **To enter standby:** Tap the standby button, or say **"Standby Bird"**
- **To wake Bird:** Say **"Hello Bird"**
