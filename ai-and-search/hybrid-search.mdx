...
Search covers everything in your workspace: voice transcripts, OCR'd text, PDF extractions, imported documents, note content, and attachment metadata.
...
Everything captured or imported into Bower is indexed for search immediately — there's no delay between capture and searchability. This includes the full text of transcripts, OCR extractions, and document content, as well as titles, tags, and metadata.
