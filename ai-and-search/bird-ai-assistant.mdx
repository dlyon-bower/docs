...
Every answer Bird gives includes **groundings** — references back to the specific notes, attachments, or web sources it used. You always know where the information came from.
...
| Output | Synthesised answer with grounded sources | List of matching notes |
