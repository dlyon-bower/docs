...
<Steps>
  ...
  <Step title="The original image is attached to the note with metadata">
    For photos taken on your phone, Bower automatically reads the embedded metadata: the actual capture time, GPS location, and device model are shown in the attachment panel alongside file size and upload time. Tap the location to open it in Maps.
  </Step>
</Steps>
